...
Important: the columns 'subject' (562), 'activity' (563) and 'id' (564) are the variables that identify uniquely each observation.

Note: the row 10300 of the merged data is the calculated mean of each feature. The row 10301 is the standard deviation.
